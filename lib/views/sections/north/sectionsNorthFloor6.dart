...
class NorthSectionsFloor6 extends StatefulWidget {
  @override
  _NorthSectionsFloor6State createState() => _NorthSectionsFloor6State();
}

class _NorthSectionsFloor6State extends State<NorthSectionsFloor6> {
  @override
