...
class WestSectionsFloor3 extends StatefulWidget {
  @override
  _WestSectionsFloor3State createState() => _WestSectionsFloor3State();
}

class _WestSectionsFloor3State extends State<WestSectionsFloor3> {
  @required
