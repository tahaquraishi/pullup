...
class WestSectionsFloor1 extends StatefulWidget {
  @override
  _WestSectionsFloor1State createState() => _WestSectionsFloor1State();
}

class _WestSectionsFloor1State extends State<WestSectionsFloor1> {
  @override
