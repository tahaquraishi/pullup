...
class WestSectionsFloor2 extends StatefulWidget {
  @override
  _WestSectionsFloor2State createState() => _WestSectionsFloor2State();
}

class _WestSectionsFloor2State extends State<WestSectionsFloor2> {
  @override
