...
import 'package:pullup/views/sections/north/sectionsNorthFloor1.dart';
import 'package:pullup/views/sections/north/sectionsNorthFloor2.dart';
import 'package:pullup/views/sections/north/sectionsNorthFloor3.dart';
import 'package:pullup/views/sections/north/sectionsNorthFloor4.dart';
import 'package:pullup/views/sections/north/sectionsNorthFloor5.dart';
import 'package:pullup/views/sections/north/sectionsNorthFloor6.dart';
import 'package:pullup/views/settings.dart';

class NorthFloors extends StatefulWidget {
  @override
  _NorthFloorsState createState() => _NorthFloorsState();
}

class _NorthFloorsState extends State<NorthFloors> {
  @required
  ...
  int sec5J = 0;
  int totalSpots5 = 0;
  final databaseReference6A = FirebaseDatabase.instance
      .reference()
      .child("North_Garage_Floor_6")
      .child("Section_A")
      .child("available_spots");
  final databaseReference6B = FirebaseDatabase.instance
      .reference()
      .child("North_Garage_Floor_6")
      .child("Section_B")
      .child("available_spots");
  final databaseReference6C = FirebaseDatabase.instance
      .reference()
      .child("North_Garage_Floor_6")
      .child("Section_C")
      .child("available_spots");
  final databaseReference6D = FirebaseDatabase.instance
      .reference()
      .child("North_Garage_Floor_6")
      .child("Section_D")
      .child("available_spots");
  final databaseReference6E = FirebaseDatabase.instance
      .reference()
      .child("North_Garage_Floor_6")
      .child("Section_E")
      .child("available_spots");
  final databaseReference6F = FirebaseDatabase.instance
      .reference()
      .child("North_Garage_Floor_6")
      .child("Section_F")
      .child("available_spots");
  final databaseReference6G = FirebaseDatabase.instance
      .reference()
      .child("North_Garage_Floor_6")
      .child("Section_G")
      .child("available_spots");
  final databaseReference6H = FirebaseDatabase.instance
      .reference()
      .child("North_Garage_Floor_6")
      .child("Section_H")
      .child("available_spots");
  final databaseReference6I = FirebaseDatabase.instance
      .reference()
      .child("North_Garage_Floor_6")
      .child("Section_I")
      .child("available_spots");
  final databaseReference6J = FirebaseDatabase.instance
      .reference()
      .child("North_Garage_Floor_6")
      .child("Section_J")
      .child("available_spots");
  ...
  Future readData() async {
    ...
    databaseReference6A.once().then((DataSnapshot snapshot) {
      setState(() {
        section6A = snapshot.value.toString();
        sec6A = snapshot.value;
      });
      print('A: ${snapshot.value}');
    });
    databaseReference6B.once().then((DataSnapshot snapshot) {
      setState(() {
        section6B = snapshot.value.toString();
        sec6B = snapshot.value;
      });
      print('B: ${snapshot.value}');
    });
    databaseReference6C.once().then((DataSnapshot snapshot) {
      setState(() {
        section6C = snapshot.value.toString();
        sec6C = snapshot.value;
      });
      print('C: ${snapshot.value}');
    });
    databaseReference6D.once().then((DataSnapshot snapshot) {
      setState(() {
        section6D = snapshot.value.toString();
        sec6D = snapshot.value;
      });
      print('D: ${snapshot.value}');
    });
    databaseReference6E.once().then((DataSnapshot snapshot) {
      setState(() {
        section6E = snapshot.value.toString();
        sec6E = snapshot.value;
      });
      print('E: ${snapshot.value}');
    });
    databaseReference6F.once().then((DataSnapshot snapshot) {
      setState(() {
        section6F = snapshot.value.toString();
        sec6F = snapshot.value;
      });
      print('F: ${snapshot.value}');
    });
    databaseReference6G.once().then((DataSnapshot snapshot) {
      setState(() {
        section6G = snapshot.value.toString();
        sec6G = snapshot.value;
      });
      print('G: ${snapshot.value}');
    });
    databaseReference6H.once().then((DataSnapshot snapshot) {
      setState(() {
        section6H = snapshot.value.toString();
        sec6H = snapshot.value;
      });
      print('H: ${snapshot.value}');
    });
    databaseReference6I.once().then((DataSnapshot snapshot) {
      setState(() {
        section6I = snapshot.value.toString();
        sec6I = snapshot.value;
      });
      print('I: ${snapshot.value}');
    });
    databaseReference6J.once().then((DataSnapshot snapshot) {
      setState(() {
        section6J = snapshot.value.toString();
        sec6J = snapshot.value;
      });
      print('J: ${snapshot.value}');
    });
    setState(() {
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) => NorthSectionsFloor6()));
                    },
                    child: Container(
                      width: 293.0,
                      height: 55.0,
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) => NorthSectionsFloor5()));
                    },
                    child: Container(
                      width: 293.0,
                      height: 55.0,
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) => NorthSectionsFloor4()));
                    },
                    child: Container(
                      width: 293.0,
                      height: 55.0,
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) => NorthSectionsFloor3()));
                    },
                    child: Container(
                      width: 293.0,
                      height: 55.0,
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) => NorthSectionsFloor2()));
                    },
                    child: Container(
                      width: 293.0,
                      height: 55.0,
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) => NorthSectionsFloor1()));
                    },
                    child: Container(
                      width: 293.0,
                      height: 55.0,
