...
import 'package:pullup/views/sections/sectionsNorth.dart';
import 'package:pullup/views/sections/sectionsSouth.dart';
import 'package:pullup/views/sections/sectionsWest.dart';
...
Future<void> main() async {
  ...
  // runApp(NorthFloors());
  // runApp(WestFloors());
  // runApp(SouthSections());
  // runApp(NorthSections());
  // runApp(WestSections());
  // runApp(AnnouncementsScreen());
